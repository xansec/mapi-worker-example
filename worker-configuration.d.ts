/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cf3c2524d13c66c31ba4a45f5cb3209b)
// Runtime types generated with workerd@1.20260219.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MapiContainer";
	}
	interface Env {
		MAYHEM_URL: string;
		MAYHEM_TOKEN: string;
		...
		MAPI_CONTAINER: DurableObjectNamespace<import("./src/index").MapiContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAYHEM_URL" | "MAYHEM_TOKEN" | "CF_ACCESS_CLIENT_ID" | "CF_ACCESS_CLIENT_SECRET">> {}
}
